...
const designs = [
  {
    ...
    prompt:
      "A neon vaporwave-inspired hoodie with glowing gradients, retro grid lines, and a synthwave sunset on the back.",
    image: hoodie0,
  ...
  },
  {
    title: "Cyber Panther",
    prompt:
      "Futuristic black hoodie featuring a cybernetic panther, teal highlights, and subtle circuit patterns across the chest.",
    image: hoodie1,
  ...
  },
  {
    ...
    prompt:
      "Bold street-art hoodie with layered graffiti tags, paint splatters, and a chrome drip logo on the sleeve.",
    image: hoodie2,
  ...
  },
  {
    title: "Techcore Mono",
    prompt:
      "Minimal techcore hoodie in monochrome with geometric linework, barcode sleeve detail, and a subtle chest monogram.",
    image: hoodie3,
      ...
      <div className="flex flex-col sm:flex-row items-start justify-between gap-6 mb-12">
        <div>
          ...
          <p className="mt-3 max-w-xl text-base text-gray-400 leading-relaxed">
            Explore our top-rated AI-generated hoodie designs and the prompts
      ...
      <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
        {designs.map((design, index) => (
          ...
          >
            {/* Image */}
            <div
              className={`relative h-96 w-full bg-gradient-to-br ${design.accent}`}
            >
              <img
                src={design.image}
                alt={design.title}
