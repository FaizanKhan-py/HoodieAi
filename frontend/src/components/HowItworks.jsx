      ...
      <ul className="flex flex-col md:flex-row gap-6 md:gap-3 justify-evenly items-stretch w-full px-2">
        <li className="md:w-1/4 w-full hover:bg-white hover:text-black p-4 rounded-2xl transition-colors duration-200 mb-2 md:mb-0">
          <ul className="flex gap-4 items-start">
            <li className="border rounded-4xl  pl-3 pr-3 h-9 flex items-center">1</li>
            <li className="flex flex-col">
              <h2 className="font-bold mb-1 ">Create & Describe</h2>
              <p className="">
        ...
        <li className="md:w-1/4 w-full hover:bg-white hover:text-black p-4 rounded-2xl transition-colors duration-200 mb-2 md:mb-0">
          <ul className="flex gap-4 items-start">
            <li className="border rounded-4xl  pl-3 pr-3 h-9 flex items-center">2</li>
            <li className="flex flex-col">
              <h2 className="font-bold mb-1 ">Generate</h2>
              <p className="">
        ...
        <li className="md:w-1/4 w-full hover:bg-white hover:text-black p-4 rounded-2xl transition-colors duration-200">
          <ul className="flex gap-4 items-start">
            <li className="border rounded-4xl  pl-3 pr-3 h-9 flex items-center">3</li>
            <li className="flex flex-col">
              <h2 className="font-bold mb-1  ">Order</h2>
              <p className="">
